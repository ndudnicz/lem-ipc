...
// )
// {
// 	m[0] = 	can_go_up(p, board) && board->b[p->y - 1][p->x].team < 0;
// 	m[1] = 	can_go_down(p, board) && board->b[p->y + 1][p->x].team < 0;
// 	m[2] = 	can_go_left(p, board) && board->b[p->y][p->x - 1].team < 0;
// 	m[3] = 	can_go_right(p, board) && board->b[p->y][p->x + 1].team < 0;
//
// }
//
// static t_s32	ft_abs(
